...
class FacebookAppEventsPlugin: FlutterPlugin, MethodCallHandler {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "facebook_app_events")
  ...
  override fun onMethodCall(call: MethodCall, result: Result) {
    when (call.method) {
      ...
      "search" -> handleSearchTracking(call, result)
  ...
  private fun handleSearchTracking(call: MethodCall, result: Result) {
    val parameters = call.argument("parameter") as? String
    val param = mapOf(AppEventsConstants.EVENT_PARAM_SEARCH_STRING to parameters) as? Map<String,Objects>
    val parameterBundle = createBundleFromMap(param)
    appEventsLogger.logEvent( AppEventsConstants.EVENT_NAME_SEARCHED  , parameterBundle)
    result.success(null);
  }
  ...
  private fun handleLogEvent(call: MethodCall, result: Result) {
    ...
    Log.d(logTag, "EventName " + eventName)
