...
class _SellingItemsState extends State<SellingItems> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () async {
      //await Provider.of<BrandItemsList>(context).getLoyalty();
    ...
    if(_isWeb && !ResponsiveLayout.isSmallScreen(context)) {
      return Container(
        ...
        height: MediaQuery
            .of(context)
            .size
            .height * 0.90, //aaaaaaaaaaaaaaaaaa
        child: Container(
                                                    ...
                                                    GestureDetector(
                                                      onTap: () {
                                                        if (item.itemQty <
                                                          ...
                                                          Fluttertoast.showToast(
                                                              msg:
                                                              translate('forconvience.Out of stock popup') , // "Sorry, Out of Stock!",
                                                              backgroundColor:
                                                              Colors
                                                                  .black87,
                                                              textColor:
...
//                                            width: 40,
                        ...
                        Column(
                          ...
                          // ),*/
                                ...
                                //     ),
                                //     child: Text(
                                //       margins + "% translate('forconvience.OFF')",
                                //       textAlign: TextAlign.center,
                                //       style: TextStyle(
                                //           fontSize: 12,
