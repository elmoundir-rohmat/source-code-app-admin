...
class _SubCategoriesGridState extends State<SubCategoriesGrid> {
  ...
  Widget build(BuildContext context) {
    ...
    // debugPrint("expand length"+subcategoryData.length.toString());
    // debugPrint("expand title"+subcategoryData[0].title.toString());
    ...
    subcategoryData.itemNested[i].title,
                    style: TextStyle(
                      color: (widget.subcatid==subcategoryData.itemsubNested[i].subcatid)?ColorCodes.discount:Colors.black
                    ),
                  ),
                ),
              )
